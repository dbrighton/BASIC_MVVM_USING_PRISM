...
namespace BASIC_MVVM_CORE.Controls
{
    ...
    {
        public static readonly DependencyProperty ProcessFourIsRunningProperty =
            DependencyProperty.Register(
            "ProcessFourIsRunning", typeof(bool), typeof(TopBarMenuCtrl),
        ...
        public static readonly DependencyProperty ProcessThreeIsRunningProperty =
            DependencyProperty.Register(
            "ProcessThreeIsRunning", typeof(bool), typeof(TopBarMenuCtrl),
            new PropertyMetadata(default(bool)));
